$(function(){
	...
	$($("button.finish")[0]).on('click', function(event){
	...
	var correctAnswer = function() {
		...
		$('.answer')[currentQuestionCorrect].style.background = "#1DAD69";
		if(buzzedInPlayer == 1) {
			player1Score++
	...
	var incorrectAnswer = function(answerIndex) {
		...
		$('.answer')[answerIndex].style.background = "#C34C48";
		$('.answer')[currentQuestionCorrect].style.background = "#1DAD69";
		loadNextQuestion();
	};
